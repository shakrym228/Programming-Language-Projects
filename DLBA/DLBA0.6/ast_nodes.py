# ast_nodes.py - DLBA v0.6 AST node definitions
...
class Import:
    def __init__(self, path, as_name=None):
        self.path = path
        self.as_name = as_name  # optional alias
        self.lineno = None
        self.filename = None

class ModuleAccess:
    """Member access with dot: object.member"""
...
class DictLiteral:
    def __init__(self, pairs):
        # pairs: list of (key_expr, value_expr) ; keys usually string literals
        self.pairs = pairs
