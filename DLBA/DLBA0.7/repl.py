# repl.py - DLBA REPL with readline/history and stdlib registration (v0.7)
import os
...
def repl():
    ...
    buffer = ""
    print(
        "DLBA REPL[demo version (0.7), September 25 2025 (1404 Mehr 3)].\nFor exit type 'exit' or 'quit'."
    )
    while True:
        try:
            ...
            try:
                ...
                # if parser expects more input, continue reading
                if "Unexpected end of input" in str(e):
                    continue
                # else real parse error: show and clear buffer
                raise
            try:
